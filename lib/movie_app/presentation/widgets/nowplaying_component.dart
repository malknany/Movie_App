...
import '../pages/movie_detailes.dart';
...
class NowPlayingComponet extends StatelessWidget {
  const NowPlayingComponet({super.key});
                        ...
                        children: [
                          ShaderMask(
                            ...
                            child: CachedNetworkImage(
                              height: 560.0,
                              imageUrl:
                                  AppConstance.getImage(item.backdropPath),
                              fit: BoxFit.cover,
                            ),
                          ),
                          Align(
